...
public class EnemyAIPatrol : MonoBehaviour
{
    ...
    //devriye sistemi için
    NavMeshAgent agent;
    public Transform[] waypoints;
    int waypointsIndex;
    Vector3 target;
    bool patrolFinish = false;

    private void Start()
    {
        _agent = GetComponent<NavMeshAgent>();// oyuncuyu fark etmesi için
        agent = GetComponent<NavMeshAgent>(); // devriye için
        UpdateDestination();
    }
